...
public class UserProfileApiVerticle extends AbstractVerticle {
	...
	public Completable rxStart() {
		...
		userUtil = MongoUserUtil.create(mongoClient, new MongoAuthenticationOptions(),
	...
	private boolean anyRegistrationFieldIsMissing(JsonObject body) {
		return !(body.containsKey("username") && body.containsKey("password")
				&& body.containsKey("email") && body.containsKey("city")
				&& body.containsKey("deviceId") && body.containsKey("makePublic"));
	}
	...
	public static void main(String[] args) {
		Vertx.vertx().rxDeployVerticle(new UserProfileApiVerticle()).subscribe(
