...
public class DashboardWebAppVerticle extends AbstractVerticle {
    ...
    public Completable rxStart() {
        ...
        KafkaConsumer<String, JsonObject> throughputConsumer = KafkaConsumer.create(vertx,
        ...
        throughputConsumer.subscribe("event-stats.throughput");

        KafkaConsumer<String, JsonObject> cityTrendConsumer = KafkaConsumer.create(vertx,
        ...
        cityTrendConsumer.subscribe("event-stats.city-trend.updates");

        KafkaConsumer<String, JsonObject> rankingConsumer = KafkaConsumer.create(vertx,
        ...
        rankingConsumer.subscribe("event-stats.user-activity.updates");
